...
import 'package:quicha/view/login_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          SvgPicture.asset(
            "assets/images/background/sign_background.svg",
            fit: BoxFit.fill,
          ),
          Align(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  Text("クイズで盛り上がろう", style: TextStyle(color: Colors.black)),
                ],
              ),
            ),
          ),
          ...
          Align(
            ...
            child: SizedBox(
                ...
                child: Lottie.asset(
                  "assets/lottile/chat_animation.json",
                )),
          ),
          Align(
            alignment: Alignment.bottomCenter,
            child: _SignUpOrSignIn(size: size),
          ),
        ],
      ),
    );
        ...
        child: Stack(
          children: [
            Align(
                ...
                child: Icon(
                  isRegister ? Icons.person_add : Icons.lock,
            ...
            Align(
                ...
                child: Text(title,
                    style: GoogleFonts.mochiyPopOne(
                        ...
                        color: isRegister ? Color(0xFF4A4A4A) : Colors.white))
